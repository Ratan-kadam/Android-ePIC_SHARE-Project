...
public class crtegrp extends ActionBarActivity {
 Button crtgrp;
 EditText crttext;
...
// TextView crttext =(TextView)findViewById(R.id.crttext);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crtegrp);
        UserFromPrevWindow1 = getIntent().getStringExtra("UserFromPrevWindow");
        crttext =(EditText)findViewById(R.id.crttext);
        crtgrp =(Button)findViewById(R.id.crtgrp);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_crtegrp, menu);
        return true;
    }
    ...
    public void CreateGroup()
    {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("groupname",crttext.getText().toString() ));
            ...
            if(a.equals("success")){
                ...
                Log.e("data","SuccessFull Group Creation");
